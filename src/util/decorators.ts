...
/* SEE: https://github.com/angular/angular/blob/master/modules/angular2/src/util/decorators.ts */

import {Type, isFunction, stringify, global} from '../facade/lang';
    ...
    function DecoratorFactory(objOrType):(cls:any) => any {
        ...
        if (this instanceof annotationCls) {
            ...
            var TypeDecorator:TypeDecorator = <TypeDecorator>function TypeDecorator(cls) {
                ...
                registerLegacy(cls, annotations);
